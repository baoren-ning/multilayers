...
def get_ma():
    ...
    znse_path = filename + '/znse.csv'
    nk_si = np.genfromtxt(si_path, delimiter=',')[54:105]
    nk_sio2 = np.genfromtxt(sio2_path, delimiter=',')[54:105]    #51:402
    nk_vo2_h = np.genfromtxt(vo2_h_path, delimiter=',')[54:105]
    # nk_ag = np.genfromtxt(ag_path, delimiter=',')[54:105]
    nk_al2o3 = np.genfromtxt(al2o3_path, delimiter=',')[54:105]
    nk_hfo2 = np.genfromtxt(hfo2_path, delimiter=',')[54:105]
    nk_mgf2 = np.genfromtxt(mgf2_path, delimiter=',')[54:105]
    nk_zno = np.genfromtxt(zno_path, delimiter=',')[54:105]
    nk_zns = np.genfromtxt(zns_path, delimiter=',')[54:105]
    nk_si3n4 = np.genfromtxt(si3n4_path, delimiter=',')[54:105]
    nk_sic = np.genfromtxt(sic_path, delimiter=',')[54:105]
    nk_tio2 = np.genfromtxt(tio2_path, delimiter=',')[54:105]  #51:402
    # nk_znse = np.genfromtxt(znse_path, delimiter=',')[1:]
    nk_znse = np.genfromtxt(znse_path, delimiter=',')[54:105]
    ...
    material_matrix = np.concatenate(
        [
             refractive_index_si         #1 前39个折射率有问题
            ,refractive_index_sio2
            ,refractive_index_vo2_h
            ,refractive_index_al2o3
            ,refractive_index_hfo2
            ,refractive_index_mgf2
            , refractive_index_zno
            , refractive_index_zns
            , refractive_index_si3n4
            , refractive_index_sic
            # , refractive_index_ag
            ,refractive_index_tio2       #1
            ,refractive_index_znse     #1
         ]
        , axis=1)
